...
const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "## Sheet: Calculations",
      "",
      "| Name | Formula | Inputs | Notes |",
      "| --- | --- | --- | --- |",
      "| TBD | TBD | TBD | TBD |",
      "",
      "## Sheet: QA / Checks",
      "",
      "| Check | Logic | Owner | Status |",
      "| --- | --- | --- | --- |",
      "| TBD | TBD | TBD | TBD |",
      "",
      "## Notes",
...
function inferSections(domain: string, docType: string): Section[] {
  ...
  if (includesAny(docTypeKey, ["slide", "slides", "ppt", "pptx", "deck", "presentation"])) {
    addSections(sections, [
      { heading: "Title slide" },
      { heading: "Agenda" },
      { heading: "Problem / Opportunity" },
      { heading: "Goals / Success criteria" },
      { heading: "Solution overview" },
      { heading: "Architecture (placeholder)" },
      { heading: "Plan & milestones" },
      { heading: "Risks & mitigations" },
      { heading: "Q&A" },
    ])
  }

  if (includesAny(docTypeKey, ["spreadsheet", "sheet", "excel", "xlsx", "workbook"])) {
    addSections(sections, [
      { heading: "Sheet: Summary" },
      { heading: "Sheet: Data" },
      { heading: "Sheet: Calculations" },
      { heading: "Sheet: QA / Checks" },
      { heading: "Notes" },
    ])
  }
